...
Envia ao Ticketer o histórico anterior da conversa após a abertura do ticket.
...
```json
{
  ...
  "metadata": {
    "flow": { "uuid": "8c7b6a5d-4e3f-4201-9a8b-7c6d5e4f3a2b", "name": "Fluxo de atendimento" },
    "channel": { "uuid": "9b8a7c6d-5e4f-4302-1a2b-3c4d5e6f7a8b", "name": "WhatsApp BR" }
  }
}
```
...
Endpoint opcional. Caso o parceiro não queira receber histórico, pode não implementá-lo ou retornar `200 OK` sem executar nenhuma ação.
