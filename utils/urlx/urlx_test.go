...
func TestExt(t *testing.T) {
	tcs := []struct {
		...
		// zendesk keeps the filename in the query string
		{"https://d3v-nyaruka.zendesk.com/attachments/token/EWTWEGWE/?name=IhCY7aKs_400x400.jpg", ".jpg"},
		{"https://coolfiles.com/download?filename=report.pdf", ".pdf"},
		// signed URLs with no filename anywhere have no extension
		{"https://media.us1.twilio.com/ME59b872?Expires=1647355356&Signature=n05WWrmDwS4y~wl0p5__&Key-Pair-Id=APKAJWF6YVTMIIYOF3AA", ""},
	}
