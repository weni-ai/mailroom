			...
			SQLAssertions: []handlers.SQLAssertion{
				...
				},
				{
					...
					Args: []interface{}{
						...
						`{"templating":{"template":{"uuid":"9c22b594-fcab-4b29-9bcb-ce4404894a80","name":"revive_issue"},"language":"eng","country":"US","variables":["Alexandia","tooth"],"namespace":"2d40b45c_25cd_4965_9019_f05d0124c5fa","category":"marketing"}}`,
